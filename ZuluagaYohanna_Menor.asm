...
.text #Intrucciones del programa
    ...
    #Se realiza la operacion de comparaciòn para encontrar el numero menor
    
    #Se compara primero entre $t0 y $t1 usando la instrucciòn blt
    blt $t0, $t1, comparar2
    # se mueve el resultado menor que es $t0 por ahora
    move $t0, $t1
    
    comparar2:
    #Se compara segundo entre $t0 y $t2 usando la instrucciòn blt
    blt $t0, $t2, resultadoFinal
    # se mueve el resultado menor que es $t0 
    move $t0, $t2
